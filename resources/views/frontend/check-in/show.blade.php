                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="img-cards" id="printidcard">
                                                <div class="id-card-holder">
                                                    <div class="id-card">
                                                        <div class="id-card-photo"> <img src="{{ asset($visitingDetails->visitor->photo) }}" alt="">
                                                            @if($visitingDetails->getFirstMediaUrl('visitor'))
                                                               <!-- <img src="{{ asset($visitingDetails->visitor->photo) }}" alt="">-->
                                                                @else
                                                       ...
                                                       <!-- <p><strong>{{ setting('site_name') }} </strong></p>
                                                        ...
                                                        <img src="<?php echo "https://qudratech-eg.net/visitorpass/public/";?>{{ $visitingDetails->qrcode}}" alt="" style="max-width: 60% !important;">
                                                    </div>
                                                </div>
                                            </div>
